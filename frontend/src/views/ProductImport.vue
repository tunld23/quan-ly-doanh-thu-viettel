...
const handleImport = async () => {
  ...
  try {
    ...
    toast.error(
      err.response?.data?.error || "Có lỗi xảy ra khi import sản phẩm",
    );
    console.error(err);
  } finally {
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div class="space-y-2">
            <label
              class="flex items-center text-xs font-black uppercase tracking-wider text-gray-500 mb-3 ml-1"
            >
              <svg
        ...
        <div class="mb-8 p-5 bg-blue-50/50 rounded-2xl border border-blue-100">
          ...
          >
            ...
            <div>
              <p class="font-black uppercase tracking-widest mb-2">
                Quy ước nạp Sản phẩm:
              </p>
              <ul class="space-y-1 ml-1">
                <li class="flex items-center gap-1.5">
                  <div class="w-1 h-1 bg-blue-400 rounded-full"></div>
                  <b>Mã hàng:</b> Cột B | <b>Mặt hàng:</b> Cột C
                </li>
                <li class="flex items-center gap-1.5">
                  <div class="w-1 h-1 bg-blue-400 rounded-full"></div>
                  <b>Doanh thu:</b> Cột K, L, M | <b>Nhân viên:</b> Cột AB
                </li>
                <li class="flex items-center gap-1.5">
                  <div class="w-1 h-1 bg-blue-400 rounded-full"></div>
                  <b>Trạng thái (Hủy):</b> Cột AD
                </li>
                <li class="flex items-center gap-1.5">
                  <div class="w-1 h-1 bg-blue-400 rounded-full"></div>
                  <b>Product Hierarchy:</b> Cột <b>AP</b>
                </li>
              </ul>
            </div>
          </div>
