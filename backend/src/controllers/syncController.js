  ...
  try {
    ...
    if (masterFiles.length > 0) {
      ...
      try {
        ...
        productTable.columns.add("tr_month", sql.NVarChar(2), {
          nullable: false,
        });
        productTable.columns.add("ma_hang", sql.NVarChar(255), {
          nullable: false,
        });
        productTable.columns.add("mat_hang", sql.NVarChar(255), {
          nullable: false,
        });
        ...
        productTable.columns.add("nhan_vien", sql.NVarChar(255), {
          nullable: true,
        });
        productTable.columns.add("product_group", sql.NVarChar(255), {
          nullable: true,
        });
    ...
    try {
      ...
      detailTable.columns.add("nhan_vien", sql.NVarChar(255), {
        nullable: false,
      });
      detailTable.columns.add("ma_hang", sql.NVarChar(255), {
        nullable: false,
      });
      detailTable.columns.add("mat_hang", sql.NVarChar(255), {
        nullable: false,
      });
      detailTable.columns.add("amount", sql.Float, { nullable: true });
      detailTable.columns.add("product_group", sql.NVarChar(255), {
        nullable: true,
      });

      for (const file of salesFiles) {
        if (
          file.includes("TONGHOP") ||
          file.includes("~") ||
